...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-sample" enctype="multipart/form-data" method="post" action="{{route('genre.update',$list_edit->id)}}">
                @csrf
                @method('PUT')  
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            <div class="form-check">
                ...
                <button class="btn btn-danger">Sửa Mới Thể Loại</button>
                <a href="" class="btn btn-success">Không Lưu Xóa Bỏ</a>
                <a href="{{route('genre.index')}}" class="btn btn-info">Đến Đến Trang Danh Sách</a>
            </form>
        </div>
    </div>
</div>
