...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tạo Mới Thể Loại</h4>
            <form class="form-sample" enctype="multipart/form-data" method="post" action="{{route('genre.store')}}">
                @csrf
                ...
                <button class="btn btn-danger">Thêm Mới Thể Loại</button>
