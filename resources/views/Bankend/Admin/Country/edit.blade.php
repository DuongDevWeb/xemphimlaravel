...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Sửa Mới Quốc Gia</h4>
            <form class="form-sample" enctype="multipart/form-data" method="post" action="{{route('country.update',$list_edit->id)}}">
                @csrf
                @method('PUT')  
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            <div class="form-check">
                ...
                <button class="btn btn-danger">Sửa Mới Quốc Gia</button>
                <a href="" class="btn btn-success">Không Lưu Xóa Bỏ</a>
                <a href="{{route('country.index')}}" class="btn btn-info">Đến Đến Trang Danh Sách</a>
            </form>
        </div>
    </div>
</div>
