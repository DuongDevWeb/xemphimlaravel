...
<div class="col-12 grid-margin">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Tạo Mới Quốc Gia</h4>
            <form class="form-sample" enctype="multipart/form-data" method="post" action="{{route('country.store')}}">
                @csrf
                ...
                <button class="btn btn-danger">Thêm Mới Quốc Gia</button>
